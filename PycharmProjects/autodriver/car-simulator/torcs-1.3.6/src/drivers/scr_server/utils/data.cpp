...
const ::IceInternal::DefaultValueFactoryInit<::DataFlow::TensorInfo> iceC_DataFlow_TensorInfo_init("::DataFlow::TensorInfo");
...
DataFlow::TensorInfo::~TensorInfo()
{
}

const ::std::string&
DataFlow::TensorInfo::ice_staticId()
{
    static const ::std::string typeId = "::DataFlow::TensorInfo";
    return typeId;
}

DataFlow::TensorInfos::~TensorInfos()
{
}
...
::IceProxy::Ice::Object* ::IceProxy::DataFlow::upCast(::IceProxy::DataFlow::TensorInfo* p) { return p; }

void
::IceProxy::DataFlow::_readProxy(::Ice::InputStream* istr, ::IceInternal::ProxyHandle< ::IceProxy::DataFlow::TensorInfo>& v)
{
    ::Ice::ObjectPrx proxy;
    istr->read(proxy);
    if(!proxy)
    ...
    {
        v = new ::IceProxy::DataFlow::TensorInfo;
        v->_copyFrom(proxy);
    }
}

::IceProxy::Ice::Object*
IceProxy::DataFlow::TensorInfo::_newInstance() const
{
    return new TensorInfo;
}

const ::std::string&
IceProxy::DataFlow::TensorInfo::ice_staticId()
{
    return ::DataFlow::TensorInfo::ice_staticId();
}
::IceProxy::Ice::Object* ::IceProxy::DataFlow::upCast(::IceProxy::DataFlow::TensorInfos* p) { return p; }

void
::IceProxy::DataFlow::_readProxy(::Ice::InputStream* istr, ::IceInternal::ProxyHandle< ::IceProxy::DataFlow::TensorInfos>& v)
{
    ::Ice::ObjectPrx proxy;
    istr->read(proxy);
    if(!proxy)
    ...
    {
        v = new ::IceProxy::DataFlow::TensorInfos;
        v->_copyFrom(proxy);
    }
}

::IceProxy::Ice::Object*
IceProxy::DataFlow::TensorInfos::_newInstance() const
{
    return new TensorInfos;
}
...
{
    {
        for(::DataFlow::NDArrayMap::iterator _i0 = datas.begin(); _i0 != datas.end(); ++_i0)
        {
            if((*_i0).second)
            {
                if((::DataFlow::upCast((*_i0).second.get())->_iceGcVisit(v_)))
                {
                    (*_i0).second = 0;
                }
            }
...
::Ice::Object* DataFlow::upCast(::DataFlow::TensorInfo* p) { return p; }

::Ice::ObjectPtr
DataFlow::TensorInfo::ice_clone() const
{
    ::Ice::Object* p = new TensorInfo(*this);
    return p;
}

namespace
{
const ::std::string iceC_DataFlow_TensorInfo_ids[2] =
{
    "::DataFlow::TensorInfo",
    "::Ice::Object"
};
...
bool
DataFlow::TensorInfo::ice_isA(const ::std::string& s, const ::Ice::Current&) const
{
    return ::std::binary_search(iceC_DataFlow_TensorInfo_ids, iceC_DataFlow_TensorInfo_ids + 2, s);
}

::std::vector< ::std::string>
DataFlow::TensorInfo::ice_ids(const ::Ice::Current&) const
{
    return ::std::vector< ::std::string>(&iceC_DataFlow_TensorInfo_ids[0], &iceC_DataFlow_TensorInfo_ids[2]);
}

const ::std::string&
DataFlow::TensorInfo::ice_id(const ::Ice::Current&) const
{
    return ice_staticId();
}
...
DataFlow::TensorInfo::ice_staticId()
{
    ...
    return typeId;
#else
    return iceC_DataFlow_TensorInfo_ids[0];
#endif
}

void
DataFlow::TensorInfo::_iceWriteImpl(::Ice::OutputStream* ostr) const
{
    ostr->startSlice(ice_staticId(), -1, true);
    Ice::StreamWriter< ::DataFlow::TensorInfo, ::Ice::OutputStream>::write(ostr, *this);
    ostr->endSlice();
}

void
DataFlow::TensorInfo::_iceReadImpl(::Ice::InputStream* istr)
{
    istr->startSlice();
    Ice::StreamReader< ::DataFlow::TensorInfo, ::Ice::InputStream>::read(istr, *this);
    istr->endSlice();
}
...
::Ice::ValueFactoryPtr
DataFlow::TensorInfo::ice_factory()
{
    return ::IceInternal::factoryTable->getValueFactory(::DataFlow::TensorInfo::ice_staticId());
}

void
DataFlow::_icePatchObjectPtr(TensorInfoPtr& handle, const ::Ice::ObjectPtr& v)
{
    handle = ::DataFlow::TensorInfoPtr::dynamicCast(v);
    if(v && !handle)
    {
        IceInternal::Ex::throwUOE(::DataFlow::TensorInfo::ice_staticId(), v);
    }
}
...
::Ice::Object* DataFlow::upCast(::DataFlow::TensorInfos* p) { return p; }
...
#endif
::Ice::ObjectPtr
DataFlow::TensorInfos::ice_clone() const
{
    ::Ice::Object* p = new TensorInfos(*this);
    return p;
}
#if defined(_MSC_VER) && (_MSC_VER >= 1900)
#   pragma warning(pop)
...
namespace
{
const ::std::string iceC_DataFlow_TensorInfos_ids[2] =
{
    "::DataFlow::TensorInfos",
    "::Ice::Object"
};
...
bool
DataFlow::TensorInfos::ice_isA(const ::std::string& s, const ::Ice::Current&) const
{
    return ::std::binary_search(iceC_DataFlow_TensorInfos_ids, iceC_DataFlow_TensorInfos_ids + 2, s);
}

::std::vector< ::std::string>
DataFlow::TensorInfos::ice_ids(const ::Ice::Current&) const
{
    return ::std::vector< ::std::string>(&iceC_DataFlow_TensorInfos_ids[0], &iceC_DataFlow_TensorInfos_ids[2]);
}

const ::std::string&
DataFlow::TensorInfos::ice_id(const ::Ice::Current&) const
{
    return ice_staticId();
}
...
DataFlow::TensorInfos::ice_staticId()
{
    ...
    return typeId;
#else
    return iceC_DataFlow_TensorInfos_ids[0];
#endif
}

void
DataFlow::TensorInfos::_iceGcVisitMembers(::IceInternal::GCVisitor& v_)
{
    {
        for(::DataFlow::TensorInfoList::iterator _i0 = train.begin(); _i0 != train.end(); ++_i0)
        {
            if((*_i0))
            {
    ...
    {
        for(::DataFlow::TensorInfoList::iterator _i0 = predict.begin(); _i0 != predict.end(); ++_i0)
        {
            if((*_i0))
            {
                if((::DataFlow::upCast((*_i0).get())->_iceGcVisit(v_)))
...
void
DataFlow::TensorInfos::_iceWriteImpl(::Ice::OutputStream* ostr) const
{
    ostr->startSlice(ice_staticId(), -1, true);
    Ice::StreamWriter< ::DataFlow::TensorInfos, ::Ice::OutputStream>::write(ostr, *this);
    ostr->endSlice();
}

void
DataFlow::TensorInfos::_iceReadImpl(::Ice::InputStream* istr)
{
    istr->startSlice();
    Ice::StreamReader< ::DataFlow::TensorInfos, ::Ice::InputStream>::read(istr, *this);
    istr->endSlice();
}
...
::Ice::ValueFactoryPtr
DataFlow::TensorInfos::ice_factory()
{
    return ::IceInternal::factoryTable->getValueFactory(::DataFlow::TensorInfos::ice_staticId());
}

void
DataFlow::_icePatchObjectPtr(TensorInfosPtr& handle, const ::Ice::ObjectPtr& v)
{
    handle = ::DataFlow::TensorInfosPtr::dynamicCast(v);
    if(v && !handle)
    {
        IceInternal::Ex::throwUOE(::DataFlow::TensorInfos::ice_staticId(), v);
    }
}
