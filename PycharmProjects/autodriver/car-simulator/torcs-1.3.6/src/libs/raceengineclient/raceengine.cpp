...
extern void onReBeforeOneStep(tRmInfo *);
extern void onReAfterOneStep(tRmInfo *);
extern void onReBeforeDrive(tRmInfo *);
extern void onReAfterDrive(tRmInfo *);
static void
